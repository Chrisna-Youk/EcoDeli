      ...
      <div className='p-10 bg-gray-50 rounded-lg shadow-xl'>
        ...
        <form action="#" method="POST">
          <div className="mb-4 flex space-x-4">
            ...
            <div className="w-1/2">
              <label for="username" className="block text-sm font-medium text-gray-700">Nom d'utilisateur</label>
              <input 
                type="text" 
                id="username" 
                name="username" 
          ...
          <div className="mb-6 flex space-x-4">
            ...
            <div className="w-1/2">
              <label for="confirmPassword" className="block text-sm font-medium text-gray-700">Confirmer le mot de passe</label>
              <input 
                type="password" 
                id="confirmPassword" 
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              />
              <label for="terms" className="ml-2 text-sm text-gray-700">Accepter les conditions d'utilisation</label>
            </div>
          </div>
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-gray-600">Déjà un compte ? <a href="/login" className="text-yellow-600 hover:text-yellow-800">Se connecter</a></p>
        </div>
      </div>
    </div>
  )
