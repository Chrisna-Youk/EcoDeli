  ...
  return (
    <div className="flex flex-col w-screen mt-10">
        ...
        <div className="flex flex-row mt-2 bg-white rounded-3xl shadow-2xl">
          ...
          <input type="text" placeholder="Départ" className="bg-white outline-none indent-6 hover:bg-gray-100 hover:shadow-md duration-300 rounded-3xl" />
          <input type="text" placeholder="Destination" className="bg-white outline-none indent-6 hover:bg-gray-100 hover:shadow-md duration-300 rounded-3xl" />
          <select name="type_delivery" id="" className="bg-white min-w-20 outline-none text-gray-400 indent-3 hover:bg-gray-100 hover:shadow-md duration-300 rounded-3xl">
            ...
            <option value="" className="text-black">Petit</option>
            <option value="" className="text-black">Moyen</option>
            <option value="" className="text-black">Large</option>
          </select>
          <a href="" className="ml-12 h-13 w-13 rounded-full flex items-center justify-center outline-nonehover:shadow-md duration-300 bg-yellow-500 hover:bg-yellow-600 hover:scale-105">
      ...
      <h3 className="mt-12 ml-12 text-lg font-semibold">Les dernières offres de livraisons publiées</h3>
    ...
    <CustomersHomeCards
      ...
      <h3 className="mt-12 ml-12 text-lg font-semibold">Offres des livreurs les mieux notées </h3>
    ...
    <CustomersHomeCards
      ...
      <h3 className="mt-12 ml-12 text-lg font-semibold">Autres annonces de livraisons qui pourraient vous plaire</h3>
