...
const TransportPageCustomer = () => {
  ...
  return (
    <div className="flex flex-col w-screen mt-10">
      ...
      <h3 className="mt-12 ml-12 text-lg font-semibold">Les dernières offres de covoiturage publiées</h3>
    ...
    <CustomersHomeCards
      ...
      <h3 className="mt-12 ml-12 text-lg font-semibold">Offres covoiturage Paris - Marseille</h3>
    ...
    <CustomersHomeCards
      ...
      <h3 className="mt-12 ml-12 text-lg font-semibold">Autres annonces de covoiturage qui pourraient vous plaire</h3>
...
export default TransportPageCustomer;
