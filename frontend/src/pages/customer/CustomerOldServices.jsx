...
const CustomerOldServices = () => {
  ...
  const { data: orders} = useQuery({
    ...
    queryFn: async () => {
      const response = await http.get(`/order/customer/read/desactive/${customerId}`);
          ...
          <table className="min-w-full">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-2 text-left text-sm text-gray-600">Payé</th>
              </tr>
            </thead>
...
export default CustomerOldServices;
