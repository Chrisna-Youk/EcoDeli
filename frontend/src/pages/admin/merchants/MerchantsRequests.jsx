...
const MerchantRequestsPage = () => {
  return (
    <div className="bg-white min-h-screen py-12 px-6 flex flex-col items-center w-full">
        <div className="p-4 bg-white w-screen mb-8 shadow-md over"></div>
      <div className="w-full max-w-5xl space-y-10">
        <h1 className="text-3xl font-bold text-gray-900 flex gap-5">Demandes de professionnalisation <p className='text-yellow-500'>Commerçants</p></h1>
