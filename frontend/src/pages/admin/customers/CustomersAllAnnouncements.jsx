...
const AdminCustomersAnnouncements = () => {
  return (
    <div className="bg-white pt-0 h-screen 2xl:ml-72 py-10 overflow-x-hidden w-screen">
      ...
      <div className="flex flex-row justify-between">
        <div className="flex flex-col sm:ml-20">
          <h1 className="text-3xl font-bold text-gray-900">Gestion des annonces des clients</h1>
        </div>
      </div>
...
export default AdminCustomersAnnouncements;