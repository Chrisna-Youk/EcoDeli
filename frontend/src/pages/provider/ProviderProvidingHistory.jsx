...
const ProviderProvidingHistory = () => {
  return (
    <div className="bg-white pt-0 h-screen 2xl:ml-150 py-10 w-full overflow-x-hidden">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-md xl:w-[80vw] md:w-full">
              <h2 class="text-xl font-semibold text-gray-800 mb-4">Dernières Prestation</h2>
                  ...
                  <tbody class="bg-white">
                    <tr className="hover:bg-zinc-300">
                      ...
                      <td class="px-4 py-3 text-sm">
                        <span class="inline-flex px-2 py-1 text-xs font-medium bg-green-100 text-green-700 rounded-full">Effectué</span>
                      </td>
                    </tr>
...
export default ProviderProvidingHistory;