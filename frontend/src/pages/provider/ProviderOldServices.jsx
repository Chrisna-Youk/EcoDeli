...
const ProviderOldServices = () => {
  ...
  const { data: orders} = useQuery({
    ...
    queryFn: async () => {
      const response = await http.get(`/order/provider/read/desactive/${providerId}`);
      return response.data.data;
    },
  });

  return (
    <div className="bg-white pt-0 h-screen py-10 w-full overflow-x-hidden flex items-center flex-col xl:ml-70">
...
export default ProviderOldServices;
