    ...
    <div className="bg-white pt-0 h-screen 2xl:ml-72 py-10 w-screen overflow-x-hidden">
      ...
      <div className="flex flex-col sm:ml-20">
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <p className="text-white mt-2">
                  You have 12 deliveries scheduled for today.
                </p>
              </a>
              <a
                href="#"
        ...
        <div className="flex xl:flex-row mt-12 gap-8 flex-wrap md:flex-col">
          <div className="bg-white p-6 rounded-2xl shadow-md xl:w-[30vw] md:w-full">
              ...
              <table className="min-w-full">
                ...
                <tbody className="bg-white">
                  <tr className="hover:bg-zinc-300">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-800">€18,50</td>
                    <td className="px-4 py-3 text-sm text-gray-800">Carte</td>
                  ...
                  <tr className="hover:bg-zinc-300">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-800">€12,00</td>
                    <td className="px-4 py-3 text-sm text-gray-800">Espèces</td>
                    <td className="px-4 py-3 text-sm">
              ...
              <table className="min-w-full">
                ...
                <tbody className="bg-white">
                  <tr className="hover:bg-zinc-300">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-800">Paris</td>
                    <td className="px-4 py-3 text-sm text-gray-800">19:30</td>
                    <td className="px-4 py-3 text-sm">
                      <span className="inline-flex px-2 py-1 text-xs font-medium bg-green-100 text-green-700 rounded-full">
                        Livré
                      </span>
                  ...
                  <tr className="hover:bg-zinc-300">
                    <td className="px-4 py-3 text-sm text-gray-800">Jean</td>
                    <td className="px-4 py-3 text-sm text-gray-800">Fresne</td>
                    <td className="px-4 py-3 text-sm text-gray-800">16:30</td>
                    <td className="px-4 py-3 text-sm">
                      <span className="inline-flex px-2 py-1 text-xs font-medium bg-green-100 text-green-700 rounded-full">
                        Livré
                      </span>
                  ...
                  <tr className="hover:bg-zinc-300">
                    <td className="px-4 py-3 text-sm text-gray-800">Chris</td>
                    <td className="px-4 py-3 text-sm text-gray-800">Paris</td>
                    <td className="px-4 py-3 text-sm text-gray-800">14:15</td>
                    <td className="px-4 py-3 text-sm">
                      <span className="inline-flex px-2 py-1 text-xs font-medium bg-green-100 text-green-700 rounded-full">
                        Livré
                      </span>
                  ...
                  <tr className="hover:bg-zinc-300">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-800">Taverny</td>
                    <td className="px-4 py-3 text-sm text-gray-800">11:00</td>
                    <td className="px-4 py-3 text-sm">
                      <span className="inline-flex px-2 py-1 text-xs font-medium bg-green-100 text-green-700 rounded-full">
                        Livré
                      </span>
