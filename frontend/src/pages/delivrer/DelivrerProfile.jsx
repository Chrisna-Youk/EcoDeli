    ...
    <div className="bg-white pt-0 min-h-screen flex flex-col items-center w-screen py-10 px-4 mt-7 ml-30">
     <div className='flex flex-col items-center mt-12'>
      <img
        ...
        />
        <h3 className='text-2xl font-bold text-gray-800 mt-2'>Alexandre Rodriguez</h3>
        ...
        <div className="space-y-4 flex gap-12 flex-wrap items-center">
          ...
          <div className="rounded-lg p-4 hover:bg-gray-200 transition">
            ...
            <p className="text-gray-700 mb-1">Ponctuel et très professionnel. Je recommande !</p>
            <div className="text-yellow-500 text-sm flex flex-row items-center">
            <p>5</p> <svg className='h-6' viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"  preserveAspectRatio="xMidYMid meet" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M62 25.2H39.1L32 3l-7.1 22.2H2l18.5 13.7l-7 22.1L32 47.3L50.5 61l-7.1-22.2L62 25.2z" fill="#ffce31"></path></g></svg><span className="text-gray-300"></span>
            </div>
          </div>
