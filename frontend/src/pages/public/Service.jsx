      ...
      <div className="w-full max-w-5xl px-4">
        ...
        <form className="flex flex-row items-center space-x-2 max-w-xl mx-auto bg-amber-200 p-4 rounded-lg shadow-md">
          ...
          <div className="relative flex-1">
            ...
            <input
              type="search"
              className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-amber-500 hover:ring-amber-500"
              placeholder="Recherche"
              required
            />
            <button
              type="submit"
              className="text-white absolute end-2.5 bottom-2.5 bg-amber-600 hover:bg-amber-800 duration-300 focus:ring-4 font-medium rounded-lg text-sm px-4 py-2"
            >
              Rechercher
            </button>
          </div>
