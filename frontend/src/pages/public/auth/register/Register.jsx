...
const Register = () => {
  ...
  const loginMutation = useMutate("/auth/register");
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              <label htmlFor="terms" className="ml-2 text-sm text-gray-700">
                En vous inscrivant à notre service, vous accepter les conditions
                d'utilisation.
                <br />
                <Link
                  to="/rgpd"
                ...
                >
                  Cliquer-ici pour consulter nos conditions d'utilisations
                </Link>
              </label>
            </div>
          </div>
