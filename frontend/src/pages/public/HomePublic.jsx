    ...
    <div className="font-[Poppins] text-white bg-green-950 overflow-y-hidden">
      ...
      <div className="p-30 bg-green-950">
        <div className="flex flex-col items-center">
          <h3 className="text-2xl font-semibold">EcoDeli, la livraison collaborative et solidaire.</h3>
      ...
      <div className="flex flex-row p-10">
        ...
        <div className="bg-green-950 text-center flex flex-col items-center justify-center">
          <h3 className="text-2xl font-semibold">Particuliers</h3>
       ...
       <div className="flex flex-row-reverse p-10">
        ...
        <div className="bg-green-950 text-center flex flex-col items-center justify-center">
          <h3 className="text-2xl font-semibold">Livreurs</h3>
      ...
      <div className="flex flex-row p-10">
        ...
        <div className="bg-green-950 text-center flex flex-col items-center justify-center">
          <h3 className="text-2xl font-semibold">Prestataires</h3>
      ...
      <div className="flex flex-row-reverse p-10">
        ...
        <div className="bg-green-950 text-center flex flex-col items-center justify-center">
          <h3 className="text-2xl font-semibold">Commerçants</h3>
