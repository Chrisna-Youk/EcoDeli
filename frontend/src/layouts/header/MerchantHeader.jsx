    ...
    <>
      ...
      >
        ...
        <div className="flex flex-row items-center space-x-4">
          ...
          <h1 className="text-lg font-semibold">Espace Commerçant</h1>
        </div>
        ...
        <nav className="flex-1 space-y-2 mt-6">
          ...
          <details className="group">
            ...
            <div className="pl-8 mt-2 space-y-1 flex flex-col">
              <a
                href="/merchant/ProvidingUpComing"
                className="flex items-center gap-2 py-1 hover:text-yellow-600"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <details className="group">
            ...
            <div className="pl-8 mt-2 space-y-1 flex flex-col">
              ...
              <a
                href="/merchant/update/documents"
                className="flex items-center gap-2 py-1 hover:text-yellow-600"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
