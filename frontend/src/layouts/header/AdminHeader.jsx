          ...
          >
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 100-8 4 4 0 000 8zm6 1a4 4 0 00-3 3.87"
              />
            </svg>
            Utilisateurs
          </Link>
            ...
            <summary className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 cursor-pointer list-none">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M5.121 17.804A4 4 0 017.5 15h9a4 4 0 012.379.804M12 7a4 4 0 100-8 4 4 0 000 8z"
                />
              </svg>
              Clients
            </summary>
            ...
            <summary className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 cursor-pointer list-none">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M9 17v-6h13v6M5 11V7h3M5 11h13M5 11l-2 2m0-4l2 2"
                />
              </svg>
              Livreurs
            </summary>
            ...
            <summary className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 cursor-pointer list-none">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M3 3h18v18H3V3zM9 3v18M15 3v18M3 9h18M3 15h18"
                />
              </svg>
              Commerçants
            </summary>
