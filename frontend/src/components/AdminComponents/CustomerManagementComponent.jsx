...
const CustomerManagementComponent = ({ users = [], onEdit, onDelete }) => {
  ...
  return (
    <div className="bg-white min-h-screen py-12 px-6 flex flex-col items-center w-screen">
      ...
      <div className="w-full max-w-5xl space-y-10">
        <h1 className="text-3xl font-bold text-gray-900  flex gap-3">Gestion des <p className='text-yellow-500'>Clients</p></h1>
              ...
              {customerUsers.length === 0 && (
                <tr>
                  <td colSpan="5" className="px-6 py-4 text-center text-gray-500">
                    Aucun utilisateur avec le rôle "customer" trouvé.
                  </td>
                </tr>
              )}
            </tbody>
